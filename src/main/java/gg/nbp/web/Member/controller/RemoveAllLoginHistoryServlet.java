...
@WebServlet("/member/removeAllLoginHistoryServlet")
public class RemoveAllLoginHistoryServlet extends HttpServlet {
    @Serial
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MemberCommonUitl.gsonToJson(response, LOGIN_SERVICE.removeAll(loginRecord));
    }
}
