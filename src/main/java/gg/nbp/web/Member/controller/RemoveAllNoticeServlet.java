...
@WebServlet("/member/removeAllNoticeServlet")
public class RemoveAllNoticeServlet extends HttpServlet {

    @Serial
    private static final long serialVersionUID = -284837193588974932L;
    @Autowired
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MemberCommonUitl.gsonToJson(response, NOTICE.removeAll(notice));
    }
}
