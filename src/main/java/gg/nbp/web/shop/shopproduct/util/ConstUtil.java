...
public class ConstUtil {
    ...
    public static final String PATH="C:\\MyWorkSpace\\five\\springbootProject\\";
    public static final String CSVPATH = PATH+"gg4nbp\\src\\main\\resources\\static\\img\\gameSoftware\\test\\origin\\假資料.csv";
